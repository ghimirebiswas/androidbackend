...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Add New Routine <a class="btn btn-default" href="viewroutine.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View all </a></h1>
    </div>
    ...
    <title>Upload Routine</title>
        ...
        //$image_baseurl="http://prembasnet.com.np/download";
			if(!empty($_POST))
			{
				...
				{
					if (file_exists("routine/" . $_FILES["file"]["name"]))
					{
					...
					else
					{
						...
						"routine/" . $_FILES["file"]["name"]) ;
						mysqli_select_db($con,'e_softwarica');
                        $staffimageurl=$image_baseurl."/".$_FILES["file"]["name"];
						$sqli = "INSERT INTO tbl_routine(college_batch,file_name,routineurl) VALUES ('" . $_POST["batch"] ."','"  . 
     ...
     <body>
      ...
      <br>
        ...
        <form id="form3" enctype="multipart/form-data" method="post" action="addroutine.php">
             <table class="table table-bordered">         	
                <tr>
                    <td>	<label for="sub">Batch</label>	</td>
                    <td>	<input type="text" name="batch" id="batch" class="input-medium"  
					         required autofocus placeholder="Batch"/>	</td>
                </tr>
