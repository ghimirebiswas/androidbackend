...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="h2">All Assignment <a class="btn btn-default" href="addassignment.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Add Assignment </a></h1>
    </div>
...
<font face="comic sans ms">
 ...
 <table class="table table-bordered">
  <thead>
   <tr>
    <th style="text-align: center;"><font face="comic sans ms">Cycle</font></th>
    <th style="text-align: center;"><font face="comic sans ms">Subject</font></th>
    <th style="text-align: center;"><font face="comic sans ms">Year</font></th>
    <th style="text-align: center;"><font face="comic sans ms">Deadline</font></th>
	<th style="text-align: center;"><font face="comic sans ms">File</font></th>
    <th style="text-align: center;"><font face="comic sans ms">Action</font></th>
	...
	$q="select count(*) \"total\"  from tbl_assignment";
	...
	$k=($page_cur-1)*$dis;
	$q="SELECT * FROM tbl_assignment ORDER BY assignment_subject ASC limit $k,$dis";
	$ros=mysqli_query($link,$q);
	while($row=mysqli_fetch_array($ros))
	{

		echo '<tr>';
		echo '<td align=center>' .$row['assignment_cycle'];
		echo '<td align=center>' .$row['assignment_subject'];
        echo '<td align=center>' .$row['assignment_year'];
        echo '<td align=center>' .$row['assignment_deadline'];

		echo "<td align=center><a title='Click here to download in file.' 
		     href='download.php?id={$row['assignment_name']}'>{$row['assignment_name']} </a>"; 
		echo '</tr>';
