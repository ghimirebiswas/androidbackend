...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="h2">All Routine <a class="btn btn-default" href="addnotice.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Add Routine </a></h1>
    </div>
...
<font face="comic sans ms">
 ...
 <table class="table table-bordered">
  <thead>
   <tr>
    <th style="text-align: center;"><font face="comic sans ms">Title</font></th>
    <th style="text-align: center;"><font face="comic sans ms">Date</font></th>
	<th style="text-align: center;"><font face="comic sans ms">Routine</font></th>
	...
	$q="select count(*) \"total\"  from tbl_notice";
	...
	$k=($page_cur-1)*$dis;
	$q="SELECT * FROM tbl_notice ORDER BY notice_title ASC limit $k,$dis";
	$ros=mysqli_query($link,$q);
	while($row=mysqli_fetch_array($ros))
	{

		echo '<tr>';
		echo '<td align=center>' .$row['notice_title'];
		echo '<td align=center>' .$row['notice_date'];

		echo "<td align=center><a title='Click here to download in file.' 
		     href='download.php?id={$row['notice_description']}'>{$row['notice_description']} </a>"; 
		echo '</tr>';
